            ...
            handleModalShowHide() {
                this.setState({ showHide: !this.state.showHide })
                  ...
                  render() {
                    return (
                      <div>
                        <Button variant="success" className="signupBtn" onClick={() => this.handleModalShowHide()}>
                                    Signup
                                </Button>

                                <Modal show={this.state.showHide}>
                                    <Modal.Header closeButton onClick={() => this.handleModalShowHide()}>
                                    <Modal.Title> <img src={App} width="40" height="30" className="img" alt=""/><br/><span className="text">Appwitme</span></Modal.Title>
                                    </Modal.Header>
                                    <Modal.Body>
                                      <p  className="text-center">Please create an account by filling the details below</p>
                                      <form>
                    ...
                    <Modal.Footer>
                      ...
                      <Link onClick={() => this.handleModalShowHide()} to = '/Login'>
                        Login
                        </Link>
                        {/* <Login showHide={this.state.showHide} onClick={() => this.handleModalShowHide()}/> */}
                      <Button variant="success" className="submitBtn btn-default" onClick={() => this.handleModalShowHide()}>
                        Submit
                    </Button>
                      </div>
